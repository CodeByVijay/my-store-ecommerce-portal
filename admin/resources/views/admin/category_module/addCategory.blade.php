...
@section('main-content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-blue h4">Category Details Forms</h4>
                    <p class="mb-30">Add New Category</p>
                </div>
            </div>
            <form action="{{route('admin.addEditCategoryPost')}}" method="POST" enctype="multipart/form-data" id="categoryForm">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" name="cat_name" type="text" id="categoryName"
                            placeholder="Category Name" value="{{ old('cat_name') }}" autocomplete="off">
                        @error('cat_name')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10 d-flex">
                        <div class="custom-control custom-radio mb-5 mr-20">
                            <input type="radio" id="customRadio4" name="status" value="1" class="custom-control-input" checked>
                            <label class="custom-control-label weight-400" for="customRadio4">Active</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio5" name="status" value="0" class="custom-control-input">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2 col-md-2">
                        <button class="btn btn-primary w-100" type="button" id="addCategory">Submit</button>
                    </div>
                </div>

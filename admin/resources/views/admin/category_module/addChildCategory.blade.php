...
@section('main-content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-blue h4">Child Category Details Forms</h4>
                    <p class="mb-30">Add Child Category</p>
                </div>
            </div>
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Child Category Name <span
